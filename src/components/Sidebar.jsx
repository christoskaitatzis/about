  ...
  return (
    <aside className="hidden lg:flex fixed top-0 left-0 h-screen w-64 border-r border-gray-100 bg-white flex-col px-8 py-10 z-10">
      ...
      <a
        ...
        title="Play"
      >
        <iframe src="/park-entry.html" title="Portfolio Park"
        loading="lazy" scrolling="no"
        style="width:100%;max-width:460px;aspect-ratio:16/8.2;border:0;border-radius:22px;display:block;box-shadow:0 18px 44px -18px rgba(196,68,23,.65)"></iframe>
